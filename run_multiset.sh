...
# hypotheses from its earlier evaluation of the full official splits are
# re-scored on the subsets instead (outputs_multiset/<set>__fastconformer_ctc/).
#
...
say "official test splits, frozen 1,000-utterance subsets (seed 20260915); one model at a time"
